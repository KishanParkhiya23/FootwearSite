            ...
            <div class="row row-pb-lg product-detail-wrap">
                ...
                <div class="col-sm-5">
                    <div class="product-desc">
                        <h3>Men's Boots Shoes Maca</h3>
                        <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quam eligendi illum exercitationem a nobis commodi iusto laborum animi voluptatem ut!</p>
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <p class="addtocart"><a href="{{route('Shop')}}" class="btn btn-primary btn-addtocart mb-5 w-25"> MEN</a></p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <p class="addtocart"><a href="{{route('Shop')}}" class="btn btn-primary btn-addtocart mb-5 w-25"> WOMEN</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="review">
                                                    ...
                                                    <div class="desc">
                                                        <h4>
                                                            <span class="text-left">Jack Leeona</span>
                                                            <span class="text-right">08 April 2018</span>
                                                        </h4>
                                                        <p class="star">
                                                            <span>
